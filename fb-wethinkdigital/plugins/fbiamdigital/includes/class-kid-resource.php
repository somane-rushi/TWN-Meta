...
class Kidresource {
	...
	public function register_post_type() {
		$labels  = array(
			'name'                  => _x( 'Kid Resources', 'Post Type General Name', 'fbiamdigital' ),
			'singular_name'         => _x( 'Kid Resource', 'Post Type Singular Name', 'fbiamdigital' ),
			'menu_name'             => __( 'Kid Resources', 'fbiamdigital' ),
			'name_admin_bar'        => __( 'Kid Resource', 'fbiamdigital' ),
			'archives'              => __( 'Kid Resources', 'fbiamdigital' ),
		...
		$args    = array(
			'label'               => __( 'Kid Resource', 'fbiamdigital' ),
			'labels'              => $labels,
	...
	public function custom_fields() {
		try {
			...
			$fm = new \Fieldmanager_Group( array(
				...
				'children' => array(
					'subtitle'     => new \Fieldmanager_Textfield( esc_html__( 'Sub Title', 'fbiamdigital' ),
					...
					'rimage'  => new \Fieldmanager_Media( esc_html__( 'Image', 'fbdigitalscam' ), array(
									'mime_type'    => 'image',
					...
					'boxvideo_text'     => new \Fieldmanager_Textfield( esc_html__( 'Video Button Text', 'fbiamdigital' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					'boxdwnload_text'     => new \Fieldmanager_Textfield( esc_html__( 'Download Button Text', 'fbiamdigital' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
				),
			) );
			$fm->add_meta_box( esc_html__( 'Resource Details', 'fbiamdigital' ), $this->post_type );	
