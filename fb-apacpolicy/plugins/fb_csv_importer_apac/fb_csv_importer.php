 ...
 *
 * PHP Version 5.4
 * Plugin Name:       FB CSV Importer APAC
 * Plugin URI:        
 * Description:       Allows CSV file to be uploaded and added based off FB data CSV file APAC
 ...
 */
define('FB_CSV_APAC_IMPORTER_VERSION', '1.5.0');
