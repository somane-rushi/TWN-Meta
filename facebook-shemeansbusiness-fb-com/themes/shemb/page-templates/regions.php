...
<?php $secslider = get_post_meta( get_the_ID(), 'sec_slider', true );
    ...
    <section id="topsec">
        <div class="container-fluid pad-0">  
        	<div id="country-banner" class="country-banner owl-carousel owl-theme">
            	<?php
				...
				?>
                	<div class="item"> 
                    	<a class="popup-youtube" href="<?php echo esc_url( $vdsrc ); ?>">
                        	<img src="<?php echo esc_url( $imagesrc ); ?>" alt="Shemb"  /> </a> 
                    </div>
				<?php } ?>
            </div>
        </div>
        ...
        <section class="storiesback">
            <div class="container-fluid emparea"> 
            	<div class="row">
                    ...
                    <a href="<?php echo esc_url( $sec_tag['wel_btn_link'] ); ?>" class="stories-btn ssbt" >
...
<?php 
	...
	?>
    <?php if ( ! empty( $sec_light['add_highlights'] ) ): ?>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="sucess-slider owl-carousel wow fadeInUp" data-wow-delay="0.4s">
					...
					?>
					<div class="item" data-dot="<span><?php echo esc_html(sprintf("%02d", $cnt)); ?></span>">
...
<?php 
	$sec_img = get_post_meta( get_the_ID(), 'two_col_img', true );
	if ( ! empty( $sec_img['title'] ) ) : 	
	?> 
    <section class="noPadding whiteBG">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 paddTop35 paddBottom35">
                    <h1 class="txtDarkGreen fontOptLight text-center noMargin"> <?php echo esc_html( $sec_img['title'] ); ?></h1>
                </div>
            </div>    
        </div>
    </section>
	<?php endif; 
	if( ! empty($sec_img['image']) ){ $oneimg = wp_get_attachment_url($sec_img['image']); }
	if( ! empty($sec_img['image2']) ){ $twoimg = wp_get_attachment_url($sec_img['image2']); }
	if ( ! empty( $oneimg ) || ! empty( $twoimg ) ) : 
	?>
        ...
        <div class="container-fluid">
        	<div class="row">
        	    <div class="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="img100">
                    	<?php if ( ! empty( $oneimg ) ) : ?>
                            <a href="<?php echo esc_url( $sec_img['img1link'] ); ?>" target="_blank">
                                <img src="<?php echo esc_url( $oneimg ); ?>" alt="SheMB" class="imgPH borderGreen" />
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
			    <div class="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="img100">
                    	<?php if ( ! empty( $twoimg ) ) : ?>
                        <a href="<?php echo esc_url( $sec_img['img2link'] ); ?>" target="_blank">                            
                            <img src="<?php echo esc_url( $twoimg ); ?>" alt="SheMB" class="imgPH borderGreen" />
                        </a>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="row valign">
                <div class="col-md-6 col-12 ">
                    <div class="ssrealativearea">
                        ...
                        <?php endif; ?>
                        <?php if ( ! empty( $sec_thr['btn_link'] ) ): ?>
                            <?php /*?><a class="dbnbtnss" href="<?php echo esc_url( $sec_thr['btn_link'] ); ?>"> 
                            <i class="far fa-arrow-alt-circle-right"></i>
                            <span class="dbnbtntxt"><?php echo esc_html( $sec_thr['btn_text'] ); ?></span></a>
<?php */?>
                            <a class="dbnbtnss2" target="_blank" href="<?php echo esc_url( $sec_thr['btn_link'] ); ?>">
                                <img src="https://shemeansbusiness.fb.com/wp-content/uploads/2022/02/click-to-download-1.png" alt="Click to download" /> 
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <section class="entrprenure-area">
        <div class="container-fluid">
        	...
        	<?php
				...
				?>
                    <div class="<?php echo esc_attr($cls); ?> col-12">
