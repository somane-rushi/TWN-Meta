<?php
/**
 * Template part = Lookback, Longform
...
$lf_toggle  = false;
$lf_bgcolor = 'blue-light-bg';
$long_form  = get_post_meta( get_the_ID(), 'lookback_page_lf', true );
if ( ! empty($long_form) ) {
	$lf_toggle = fbapac_fm_get_data($long_form, 'lf_toggle');
...
<section id="longform-page-lookback" class="two-column-heading-content longform-content <?php echo esc_attr($lf_bgcolor); ?>">
	<div class="container">
		<div class="tchc-row">
