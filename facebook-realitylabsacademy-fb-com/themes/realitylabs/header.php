	...
	<header class="header header-waterfall ui-header headerFRL bgwhite headBoxShadow">
		<div class="container-full ">
			<div class="mainNavFlex">
                ...
                <a class="header-logo margin-left-no margin-right-no" href="<?php echo esc_url( get_site_url() ); ?>">
					...
					<ul class="nav nav-list fontTxt font14">
						<li class="dropdown active">
                                ...
                                <ul class="dropdown-menu txtGrey">
                                    <li><a href="<?php echo esc_url( get_site_url() ); ?>/foundation/">101 Foundation +</a></li>
                    ...
                    <ul class="nav">
                        <li>
                            ...
                            <ul class="menu-collapse collapse in" id="skills">
                                <li>
                                    <a class="waves-attach txtGrey fontXtraLight font14" href="<?php echo esc_url( get_site_url() ); ?>/foundation/">101 Foundation +</a>
                                </li>
                                <li>
