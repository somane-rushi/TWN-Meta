...
if ( 'drive.google.com' === $actual_domain) {
    ...
    $asset_url     = fbapac_create_hashed_media_url($assetsid);
    ...
    <div class="list-post-row <?php echo esc_attr($topic_class); ?>">
        ...
        <div class="lpr-main">
            ...
            <div class="lpr-meta">
                ...
                <?php echo ( ! empty($program) && ('Research' != $program) ) ? '<span class="item">Program: ' . esc_html($program) . '</span>' : ''; ?>
                <?php echo ( ! empty($topic_name) ) ? '<span class="item">' . esc_html($topic_pre) . esc_html($topic_name) . '</span>' : ''; ?>
            </div>
