<?php
/**
 * Submodule: TWO COLUMNS, CTA & IMAGE 
 *
 * @package fbsafety
 */
...
if ( isset($args['sub_fields']) && !empty($args['sub_fields']) ) :
  ...
  $two_col_cta_img_toggle = fbsafety_fm_get_data($sub_fields, 'toggle');
  if ('1' === $two_col_cta_img_toggle) :
...
?>
  ...
  <div class="image-cta-wrap <?php echo esc_attr( fbsafety_fm_get_data( $sub_fields, 'bg_color' ) ); ?>">
   	<div class="container">
      ...
      <?php
      	if ('left' === $image_pos) :
      ?>
	      <div class="image-cta-image" role="image" aria-label="<?php echo esc_attr( $img_alt); ?>">
        <?php
          if ("1" === $btn_toggle) :
        ?>
          <a 
