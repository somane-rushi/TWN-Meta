...
class ProductRelationSaveHelper
{
     ...
     */
    private function maybeTerm(int $remoteTermId, string $sourceTermName, string $taxonomyName)
    {
        // phpcs:enable
    ...
    /**
     * Restore original site if necessary.
     *
