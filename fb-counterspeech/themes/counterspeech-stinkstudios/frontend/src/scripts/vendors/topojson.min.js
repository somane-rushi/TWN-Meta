...
!(function(n, t) {
  ...
  function t(n) {
    ...
    return function(n, f) {
      f ||
        (t = r = 0), (n[0] = (t += n[0]) * e + i), (n[1] = (r += n[1]) * o + u);
    };
  }
  function r(n) {
    if (!n) return h;
  ...
  function u(n, r) {
    ...
    function a(n) {
      ...
      return 'GeometryCollection' === t
        ...
        : t in h ? { type: t, coordinates: h[t](n) } : null;
    }
    var s = t(n.transform),
      l = n.arcs,
      h = {
  ...
  var h = function() {},
    ...
    v = function(n, t) {
      ...
      function e(n, t) {
        for (var r in n) {
          var e = n[r];
          delete t[e.start], delete e.start, delete e.end, e.forEach(function(
            n
          ) {
            o[n < 0 ? ~n : n] = 1;
          }), f.push(e);
        ...
        for (var a = i[c], s = a.length, l = 0; l < s; ++l)
          for (var h = l + 1; h < s; ++h) {
            var p,
              v = a[l],
              g = a[h];
            (p = u[v])[(c = o(p, g))] !== g && p.splice(c, 0, g), (p = u[g])[
              (c = o(p, v))
            ] !== v && p.splice(c, 0, v);
          }
      return u;
    ...
    m = function() {
      ...
      return (r.push = function(t) {
        ...
        if (e[u] === r)
          return u !== --o &&
            ((i = e[o]), (l(i, r) < 0 ? n : t)((e[(i._ = u)] = i), u)), u;
      }), r;
    },
    E = function(n, e) {
      function o(n) {
      ...
      return null == e && (e = c), n.arcs.forEach(function(n) {
        ...
        for (; (t = f.pop()); ) {
          var h = t.previous,
            p = t.next;
          t[1][2] < l ? (t[1][2] = l) : (l = t[1][2]), h &&
            ((h.next = p), (h[2] = t[2]), o(h)), p &&
            ((p.previous = h), (p[0] = t[0]), o(p));
        }
        n.forEach(u);
      }), n;
    };
