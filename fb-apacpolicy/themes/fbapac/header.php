...
<div id="page" class="site">
    ...
    <?php
    if ( is_page('latest') || is_page('faq')  || is_page('login-page') || is_page('facebook-employee-form')  || is_page('external-request-form') || is_page('login') ) {
    ...
    <!--header-wrap-->
        <div class="header-wrap site-header<?php echo esc_attr($addheaderClass); ?>" id="masthead">
            <div class="wrapper">
                <!--logo-->
                    <div class="logo desktop"><a href="<?php echo esc_url(home_url('/')); ?>">FACEBOOK <span>APAC Policy Resource Hub</span></a></div>
                <!--logo-->
                
                <!--logo-->
                    <div class="logo mobile"><a href="<?php echo esc_url(home_url('/')); ?>">FB <span>Resource Hub</span></a></div>
                <!--logo-->
                        ...
                        <div class="header-nav">
                            <ul>
                                ...
                                <?php if ( is_front_page() ) : ?>
                                  <li><a href="https://docs.google.com/forms/d/1F-hTiQfLgtuI8gOuLCFPj5dnMl4_3WIMzrJxRnXwrI4/edit?usp=sharing" target="_blank">New Asset Submission</a></li>
