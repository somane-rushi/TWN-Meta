...
class Fb_Csv_Importer_Loader
{
    ...
    /**
     * _add a new action to the collection to be registered with WordPress.
     *
    ...
    /**
     * _add a new filter to the collection to be registered with WordPress.
     *
