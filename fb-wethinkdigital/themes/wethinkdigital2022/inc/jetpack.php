 ...
 */
function wethinkdigital2022_jetpack_setup() {
	// Add theme support for Infinite Scroll.
	add_theme_support(
		'infinite-scroll',
		array(
			'container' => 'main',
			'render'    => 'wethinkdigital2022_infinite_scroll_render',
			'footer'    => 'page',
		)
	);
	...
	add_theme_support(
		...
		array(
			'post-details' => array(
				'stylesheet' => 'wethinkdigital2022-style',
				'date'       => '.posted-on',
...
add_action( 'after_setup_theme', 'wethinkdigital2022_jetpack_setup' );

if ( ! function_exists( 'wethinkdigital2022_infinite_scroll_render' ) ) :
	/**
	 * Custom render function for Infinite Scroll.
	 */
	function wethinkdigital2022_infinite_scroll_render() {
		while ( have_posts() ) {
			the_post();
			if ( is_search() ) :
