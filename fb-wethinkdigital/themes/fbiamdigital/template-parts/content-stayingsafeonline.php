	...
	<a class="o-box c-listing-item c-listing-item--resources"
	   href="javascript:;" target="_blank" rel="noopener"
		...
		<div class="c-listing-item__img"
			...
			<?php endif; ?>
		>
			<div style="background:url(<?php echo esc_url( $safeimg ); ?>) no-repeat 50% 50%; background-size: cover;"></div>
			<?php if ( ! empty( $preview_img ) ): ?>
		...
		<div class="c-listing-item__body">
			<h3 class="c-listing-item__title__security"><?php echo wp_kses_post( $safe_attachment['safe_subtitle'] ); ?></h3>
			...
			<p class="c-listing-item__cta">
				<?php echo wp_kses_post( $safe_attachment['boxvideo_text'] ); ?> <i class="far fa-video"></i>
			</p>
		</div>
	</a>
</div>