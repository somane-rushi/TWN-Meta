...
class Rediscovethailand {
	 ...
	 * @var string
	 */
	var $page_template = 'page-template/page-rediscovethailand';
	...
	public function custom_fields() {
		...
		try {
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Banner Image', 'fbapac' ), $this->post_type );
			
		$fm = new \Fieldmanager_Group( array(
				'name'     => "topvideosection",
				'children' => array(
				
				'url1'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL for Desktop', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
										
				'url2'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL for Mobile', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Video section', 'fbapac' ), $this->post_type );
			...
			$fm = new \Fieldmanager_Group( array(
				...
				'title'     => new \Fieldmanager_Textfield( esc_html__( 'Main Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand VIRTUAL JOURNEY', 'fbapac' ), $this->post_type );
		...
		$fm = new \Fieldmanager_Group( array(
				...
				'url'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
		...
		$fm = new \Fieldmanager_Group( array(
				...
				'heading'     => new \Fieldmanager_Textfield( esc_html__( 'Start Your Journey Title', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
										
					'heading2'     => new \Fieldmanager_Textfield( esc_html__( 'ReStart Your Journey Title', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
							
				),
			) );
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Map Section', 'fbapac' ), $this->post_type );
			...
			$fm = new \Fieldmanager_Group( array(
				...
				'children' => array(
					...
					'datetitle'     => new \Fieldmanager_Textfield( esc_html__( 'Date Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					...
					'venuetitle'     => new \Fieldmanager_Textfield( esc_html__( 'Venue Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
										
					'venue'     => new \Fieldmanager_Textfield( esc_html__( 'Venue', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
						'url'     => new \Fieldmanager_Textfield( esc_html__( 'Google Map URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
									
				),
			) );
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Section Two', 'fbapac' ), $this->post_type );
			...
			$fm = new \Fieldmanager_Group( array(
				...
				'children' => array(
					'heading1'     => new \Fieldmanager_Textfield( esc_html__( 'Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
				'url1'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					...
					'heading2'     => new \Fieldmanager_Textfield( esc_html__( 'Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					'url2'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					
					'heading3'     => new \Fieldmanager_Textfield( esc_html__( 'Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
						'url3'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
					
					'heading4'     => new \Fieldmanager_Textfield( esc_html__( 'Heading', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
						'url4'     => new \Fieldmanager_Textfield( esc_html__( 'Video URL', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
									
				),
			) );
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Section Three', 'fbapac' ), $this->post_type );	
 ...
 'scantext1'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Desktop', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),

  'scantextm1'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Mobile', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),

 'scanlink1'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
	...
	'image2' => new \Fieldmanager_Media( esc_html__( 'Image', 'fbapac' ), array(
				...
				'description2' => new \Fieldmanager_RichTextArea( esc_html__( 'Description', 'fbapac' ), array(
				  ...
				  'scantext2'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Desktop', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),

  'scantextm2'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Mobile', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),

	 'scanlink2'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
										
				),
			) );
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Across  Thaiand', 'fbapac' ), $this->post_type );	
...
'scanlink2'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Northern Region', 'fbapac' ), $this->post_type );	
...
'scanlink1'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
  ...
  'scantextm2'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Mobile', 'fbapac' ),
	...
	'scanlink2'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Northeastern Region', 'fbapac' ), $this->post_type );	
...
'scanlink2'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Central Region', 'fbapac' ), $this->post_type );	
 ...
 'scantext2'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Desktop', 'fbapac' ),
  ...
  'scantextm2'     => new \Fieldmanager_Textfield( esc_html__( 'Scan Text for Mobile', 'fbapac' ),
	...
	'scanlink2'     => new \Fieldmanager_Textfield( esc_html__( 'Mobile Scan Link', 'fbapac' ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Southern Region', 'fbapac' ), $this->post_type );	
	...
	'maindescription'     => new \Fieldmanager_Textfield( esc_html__( 'Description', 'fbapac' ),
										array( 'attributes'       => array('style' => 'width:100%') ) ),
			...
			$fm->add_meta_box( esc_html__( 'Rediscovethailand Tech Partner', 'fbapac' ), $this->post_type );
