...
class Inovation {
	 ...
	 * @var string
	 */
	var $page_template = 'page-template/page-inovation';
	...
	public function custom_fields() {
		...
		try {
			...
			$fm->add_meta_box( esc_html__( 'Inovation Section One', 'fbapac' ), $this->post_type );
			...
			$fm->add_meta_box( esc_html__( 'Inovation Section Two', 'fbapac' ), $this->post_type );
            ...
            $fm->add_meta_box( esc_html__( 'Inovation Section Three', 'fbapac' ), $this->post_type );
            
			
			$fm = new \Fieldmanager_Group( array(
				'name'     => "sectionfour",
				'children' => array(
					'heading' => new \Fieldmanager_RichTextArea( esc_html__( 'Heading', 'fbapac' ), array(
						'attributes' => array( 'style' => 'max-width:100%;', 'cols' => 50, 'rows' => 3 ),
						'description'     => esc_html__( 'Only newlines allowed, other elements will be removed on save.', 'fbapac' ),
						'init_options'    => array(
							'paste_as_text'  => true,
			...
			$fm->add_meta_box( esc_html__( 'Inovation Section Four', 'fbapac' ), $this->post_type );
			...
			$fm->add_meta_box( esc_html__( 'Inovation Section five', 'fbapac' ), $this->post_type );
            ...
            $fm->add_meta_box( esc_html__( 'Inovation Section Seven', 'fbapac' ), $this->post_type );
            ...
            $fm->add_meta_box( esc_html__( 'Inovation Section Eight', 'fbapac' ), $this->post_type );
