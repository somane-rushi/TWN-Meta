                ...
                $.ajax(
                    {
                        ...
                        beforeSend: function () {
                            $('#search-results-sortby').css({'visibility':'hidden','height':'0'});
                            $('#search-results-title').fadeOut(125);
                            $('#the-legend-wrapper.legend-home').fadeOut(125);
                            $('#search-results-count').html('').fadeOut(125);
                        },
                            ...
                            setTimeout(function(){
	                        	  ...
	                        	  if (null !== topics) {
	                        	  	if (1 === topics.length) {
	                        	  		...
	                        	  		if ('digital-citizenship_digital_skills' == which) {
	                        	  			which = 'digital-skills';
	                        	  		}
	                        	  		if ('other-topic' == which) {
                                            which = 'other';
                                        }
                        	  			$('.post-col-content').removeClass('topic-digital-skills topic-economic-impact topic-other topic-social-impact topic-government-politics topic-safety');
                ...
                $.ajax(
                    {
                        ...
                        success : function ( response ) {
                            ...
                            if (filters == 'topic--other_topic') {
                                $('.list-post-row').removeClass('topic-digital-skills topic-economic-impact topic-social-impact topic-government-politics topic-safety');
