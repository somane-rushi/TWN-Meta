...
//wpcom_vip_load_plugin( 'fbdigitalscam' );
wpcom_vip_load_plugin( 'safe-redirect-manager' );
wpcom_vip_load_plugin( 'wp-featured-posts' );
wpcom_vip_load_plugin( 'fbiamdigital' );
wpcom_vip_load_plugin( 'wp-disable-authors' );
wpcom_vip_load_plugin( 'wp-gdpr-consent' );
wpcom_vip_load_plugin( 'meta-tracking' );
wpcom_vip_load_plugin( 'meta-privacy-policy' );
